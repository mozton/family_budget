...
extension CategoryIsarModelByIndex on IsarCollection<CategoryIsarModel> {
  Future<CategoryIsarModel?> getByRemoteId(String? remoteId) {
    return getByIndex(r'remoteId', [remoteId]);
  }

  CategoryIsarModel? getByRemoteIdSync(String? remoteId) {
  ...
  Future<List<CategoryIsarModel?>> getAllByRemoteId(
      List<String?> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
    return getAllByIndex(r'remoteId', values);
  }

  List<CategoryIsarModel?> getAllByRemoteIdSync(List<String?> remoteIdValues) {
    final values = remoteIdValues.map((e) => [e]).toList();
  ...
  Future<Id> putByRemoteId(CategoryIsarModel object) {
    return putByIndex(r'remoteId', object);
  }

  Id putByRemoteIdSync(CategoryIsarModel object, {bool saveLinks = true}) {
    return putByIndexSync(r'remoteId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByRemoteId(List<CategoryIsarModel> objects) {
    return putAllByIndex(r'remoteId', objects);
  }

  List<Id> putAllByRemoteIdSync(List<CategoryIsarModel> objects,
      {bool saveLinks = true}) {
...
extension CategoryIsarModelQueryWhereSort
  ...
  QueryBuilder<CategoryIsarModel, CategoryIsarModel, QAfterWhere> anyDate() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryIsarModelQueryProperty
  ...
  QueryBuilder<CategoryIsarModel, int, QQueryOperations> colorValueProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryIsarModel, DateTime, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'date');
    });
  }

  QueryBuilder<CategoryIsarModel, int, QQueryOperations>
  ...
  QueryBuilder<CategoryIsarModel, bool, QQueryOperations> isPrivateProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryIsarModel, String, QQueryOperations> ownerIdProperty() {
    return QueryBuilder.apply(this, (query) {
